...
## Temperature Data
This is the hourly temperature data from El Pucú Airport in Formosa (hourly). 
...
Model5 <- brm(
  ...
  control = list(adapt_delta = 0.99),
  prior = c(
    prior(normal(0.05, 0.2), class = "b", coef = "decades_since_first_entry"),
...
ggplot(filter(biometrics7, !is.na(life_history) & !is.na(Sex)), aes(x = temp_new_year, y = Weight)) + 
  ...
  theme_minimal() +
  labs(x = "Mean temperature in past year (ºC)", y = "Mass\n(g)") +
  theme(text = element_text(family = "Helvetica", size = 14),
        axis.text = element_text(size = 14),
        axis.text.y = element_text(size = 12, angle = 0, vjust = 0.5),
        axis.text.x = element_text(size = 12),
...
ggplot(filter(biometrics7, !is.na(life_history) & !is.na(Sex)), aes(x = temp_ltprop_year, y = Weight)) + 
  ...
  theme_minimal() +
  labs(x = "Proportion of hours below 20ºC in past year", y = "Mass\n(g)") +
  theme(text = element_text(family = "Helvetica", size = 14),
        axis.text = element_text(size = 14),
        axis.text.y = element_text(size = 12, angle = 0, vjust = 0.5),
...
ggplot(filter(biometrics7, !is.na(life_history) & !is.na(Sex)), aes(x = temp_utprop_year, y = Weight)) + 
  ...
  theme_minimal() +
  labs(x = "Proportion of hours above 35ºC in past year", y = "Mass\n(g)") +
  theme(text = element_text(family = "Helvetica", size = 14),
        axis.text = element_text(size = 14),
        axis.text.y = element_text(size = 12, angle = 0, vjust = 0.5),
        axis.text.x = element_text(size = 6),
...
set.seed(13)
ggplot(filter(biometrics7_scaled_th, BirthWithinYear != max(BirthWithinYear)),
...
ggplot(filter(biometrics7_scaled_th, BirthWithinNextYear != max(BirthWithinNextYear)),
...
set.seed(13)
ggplot(filter(biometrics7_scaled_th, BirthWithinYear != "2"),
