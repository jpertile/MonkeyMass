...
Model1 <- brm(
  ...
  prior = c(
    prior(normal(0.05, 0.2), class = "b", coef = "decades_since_first_entry"),  # prior for decades_since_first_entry
  ...
  cores = parallel::detectCores()  # use all available cores for faster computation
)
...
Model3F <- brm(
  ...
  prior = c(
    ...
    prior(normal(0, 0.33), class = "b", coef = "decades_since_first_entry"),  
    prior(cauchy(0, 0.7), class = "sd", group = "Subject")
  ))
